...
const Broker = () => {
  ...
  useEffect(() => {
    axios.get('https://port-admin.onrender.com/broker/viewbroker').then(res => {
      setBroker(res.data)
      setSearech(res.data)
    })
  }, [])
  ...
  const delet = (e)=>{
    axios.delete(`https://port-admin.onrender.com/broker/${e}`)
    .then((res)=>{
          ...
          <div className='card'>
            <div className='card-body'>
              <div className='d-flex justify-content-between'>
                ...
                <Link to={'/addbroker'} className='btn btn-primary vesel'>
                  Add Broker
                </Link>
              </div>
                    ...
                    {search.map(data => (
                      <tr>
                        ...
                        <td>
                          ...
                          <Link to={`/editbroker/${data._id}`}><button className='btn btn-success mx-2'>Edit</button></Link>
                        </td>
                      </tr>
                    ))}
                  </tbody>
